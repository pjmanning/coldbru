  ...
  return (
    <div className="collections">
      <header className="page-intro">
        <p className="kicker">Shopify</p>
        <h1>Shop collections</h1>
        <p>
          Live Storefront API collections (mock.shop until a Coldbru store is
          linked). House flavors live on the{' '}
          <Link to="/flavors">flavor catalog</Link>.
        </p>
      </header>
